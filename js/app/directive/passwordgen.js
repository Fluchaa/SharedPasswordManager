(function () {
	...
	angular.module('spwm').directive('passwordGen',
		function($timeout) {
			/* jshint ignore:start */
			function Arcfour () {
			...
			return {
				...
				'<div class="cell" tooltip="gen_msg" ng-click="generatePasswordStart()"><i class="fas fa-sync-alt"></i></div>' +
				'<div class="cell" tooltip="tggltxt" ng-click="toggleVisibility()"><i class="fas" ng-class="{\'fa-eye\': passwordVisible, \'fa-eye-slash\': !passwordVisible }"></i></div>' +
				'<div class="cell" tooltip="\'copy password to clipboard\'"><i class="fas fa-clipboard" ngclipboard-success="onSuccess(e);" ngclipboard-error="onError(e);" ngclipboard data-clipboard-text="{{password}}"></i></div>' +
				"</button>" +
				"</div>" +
				"</div>",
				link: function (scope) {
					...
					scope.tggltxt = 'toggle visibility';
					scope.copy_msg = 'copy password';
					scope.gen_msg = 'generate password';
					...
					scope.onSuccess = function (e) {
						OC.Notification.showTemporary('Password copied');
						e.clearSelection();
					};
